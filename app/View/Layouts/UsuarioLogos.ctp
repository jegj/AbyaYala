...
<body>
	<div id="wrapper">
		...
		<div class="container">
			<div class="col-md-1">
					<img src="../app/webroot/assets/imagenes/logo_ucv_fhe.png" alt="Humanidades" width="80" height="115">
			</div>		
				<div class="col-md-1">
				<img src="../app/webroot/assets/imagenes/logo_ucv_fc.png" alt="Ciencias" width="80" height="115">
			</div>		
		  <div id="background-banner" class="col-md-10">
