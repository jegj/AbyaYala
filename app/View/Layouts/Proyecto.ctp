...
<body>
						...
						<div class="col-md-12">							
							<div class="panel with-nav-tabs panel-default">
                				<div class="panel-heading">
			                        <ul class="nav nav-tabs" id="creditsTabs">
			                            <li id="tabAbyayala">
	...
	<footer class="bs-docs-footer" role="contentinfo">
		...
		<p>contador de visitas</p><br>
<script type="text/javascript" src="http://counter2.statcounterfree.com/private/countertab.js?c=9cb198775046435d1028692d1ce07337"></script>
