		...
		<div class="col-md-12">
			<div class="panel panel-success">
	  		<div class="panel-heading">
	  			...
	  			<p>En esta sección podra agregar una Noticia al portal AbyaYala y poder administrar su contenido.
					</p>
	  		</div>
	  		<div class="panel-body">
				  <?php
					echo $this->Form->create('News', array('role'=>'form'));
					?>
					...
					<div class="form-group">
						<?php
						echo $this->Form->submit('Crear Noticia', array('class'=>'btn btn-success'));
						?>
					</div>
